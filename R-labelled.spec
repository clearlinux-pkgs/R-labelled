...
Version  : 2.7.0
Release  : 44
URL      : https://cran.r-project.org/src/contrib/labelled_2.7.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/labelled_2.7.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600789903
